...
class BirthdayDetailView extends StatefulWidget {
  ...
  const BirthdayDetailView({super.key, required this.birthdayId});
...
class _BirthdayDetailViewState extends State<BirthdayDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    final birthdayIndex = provider.birthdays.indexWhere(
      (b) => b.id == widget.birthdayId,
    );
                ...
                children: [
                  ...
                  TextButton.icon(
                    onPressed: () async {
                      if (_isEditingNotes) {
                        // Save notes
                        final updatedBirthday = b.copyWith(
